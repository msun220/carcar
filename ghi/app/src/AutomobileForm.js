      ...
      <div className="offset-3 col-6">
        <div className="shadow p-4 mt-4">
          ...
          <form onSubmit={handleSubmit} id="create-automobile-form">
            ...
            <div className="form-floating mb-3">
                <input value={year} onChange={handleYearChange} placeholder="Year"
                    required type="number" name="year" id="year" className="form-control"/>
            ...
            <div className="mb-3">
                <select value={vehicle} onChange={handleVehicleChange} required name="vehicle" id="vehicle" className="form-select">
                  ...
                  {vehicles.map(vehicle => {return (<option key={vehicle.id} value={vehicle.id}> {vehicle.name} </option> )})}
                </select>
            </div>
